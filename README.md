...
🚦 How to Run
Provision: Run terraform apply inside the /terraform folder.

Deploy: Run ansible-playbook -i hosts deploy.yml inside the /ansible folder.

Access: Open the server's public IP in your browser on Port 80.
